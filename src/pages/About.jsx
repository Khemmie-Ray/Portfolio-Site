    ...
    return (
       ...
       <div className="content about-info">
          <div className="Bio">
            ...
            <p>I am Frontend developer with a solid foundation in building responsive and accessible web applications with frontend technologies such HTML, CSS, JavaScript, React, Bootstrap and TailwindCSS.</p>
